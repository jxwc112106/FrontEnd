...
declare const Input: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "error" | "defaultValue" | "readonly" | "type" | "allowClear" | "maxLength" | "showWordLimit">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "focus", ev: FocusEvent) => void) & ((event: "clear", ev: MouseEvent) => void) & ((event: "input", value: string, ev: Event) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "change", value: string, ev: Event) => void) & ((event: "pressEnter", ev: KeyboardEvent) => void);
        $el: any;
