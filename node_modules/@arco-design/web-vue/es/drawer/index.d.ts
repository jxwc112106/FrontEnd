...
declare const Drawer: {
    new (...args: any[]): {
        ...
        $emit: ((event: "open") => void) & ((event: "cancel") => void) & ((event: "close") => void) & ((event: "update:visible", visible: boolean) => void) & ((event: "ok") => void) & ((event: "beforeOpen") => void) & ((event: "beforeClose") => void);
        $el: any;
