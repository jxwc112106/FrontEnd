...
declare const Table: {
    new (...args: any[]): {
        ...
        $emit: ((event: "select", rowKeys: (string | number)[], rowKey: string | number, record: import("./interface").TableData) => void) & ((event: "change", data: import("./interface").TableData[], extra: import("./interface").TableChangeExtra, currentData: import("./interface").TableData[]) => void) & ((event: "pageChange", page: number) => void) & ((event: "pageSizeChange", pageSize: number) => void) & ((event: "expand", rowKey: string | number, record: import("./interface").TableData) => void) & ((event: "update:selectedKeys", rowKeys: (string | number)[]) => void) & ((event: "update:expandedKeys", rowKeys: (string | number)[]) => void) & ((event: "expandedChange", rowKeys: (string | number)[]) => void) & ((event: "selectAll", checked: boolean) => void) & ((event: "selectionChange", rowKeys: (string | number)[]) => void) & ((event: "sorterChange", dataIndex: string, direction: string) => void) & ((event: "filterChange", dataIndex: string, filteredValues: string[]) => void) & ((event: "cellClick", record: import("./interface").TableData, column: import("./interface").TableColumnData, ev: Event) => void) & ((event: "rowClick", record: import("./interface").TableData, ev: Event) => void) & ((event: "headerClick", column: import("./interface").TableColumnData, ev: Event) => void) & ((event: "columnResize", dataIndex: string, width: number) => void);
        $el: any;
