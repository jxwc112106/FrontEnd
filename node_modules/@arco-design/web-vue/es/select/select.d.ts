...
declare const _default: import("vue").DefineComponent<{
    ...
    defaultValue: {
        type: PropType<string | number | Record<string, unknown> | (string | number | Record<string, unknown>)[]>;
    ...
    fallbackOption: {
        type: PropType<boolean | ((value: string | number | Record<string, unknown>) => SelectOptionData)>;
        default: boolean;
    };
    showExtraOptions: {
        type: BooleanConstructor;
