...
declare const Checkbox: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "modelValue" | "defaultChecked" | "indeterminate" | "uninjectGroupContext">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "update:modelValue", value: boolean | (string | number | boolean)[]) => void) & ((event: "change", value: boolean | (string | number | boolean)[], ev: Event) => void);
        $el: any;
    ...
    Group: import("vue").DefineComponent<{
        ...
        options: {
            type: import("vue").PropType<(string | number | import("./interface").CheckboxOption)[]>;
        };
        direction: {
        ...
        options?: (string | number | import("./interface").CheckboxOption)[] | undefined;
...
export declare type CheckboxGroupInstance = InstanceType<typeof _CheckboxGroup>;
