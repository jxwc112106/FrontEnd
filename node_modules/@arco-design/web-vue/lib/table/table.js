...
var _Table = vue.defineComponent({
  ...
  setup(props, {
    ...
    vue.watch([columns, slotColumns], ([columns2, slotColumns2]) => {
      var _a;
      const result = utils.getGroupColumns((_a = slotColumns2 != null ? slotColumns2 : columns2) != null ? _a : [], dataColumnMap);
    ...
    const sortedData = vue.computed(() => {
      ...
      if (data.length > 0) {
        ...
        if (dragState.dragging && dragState.targetPath.length > 0) {
          const target = utils.spliceFromPath(data, dragState.sourcePath);
          utils.spliceFromPath(data, dragState.targetPath, target);
        }
      }
      return data;
    });
    ...
    const flattenRawData = vue.computed(() => flattenData.value.map((item) => item.raw));
        ...
        if (column.dataIndex) {
          if (index2 === 0) {
            ...
            flattenData.value.forEach((data) => {
              if (column.dataIndex) {
                if (is.isNumber(data.raw[column.dataIndex])) {
                  count += data.raw[column.dataIndex];
                } else if (!is.isUndefined(data.raw[column.dataIndex]) && !is.isNull(data.raw[column.dataIndex])) {
                  isNotNumber = true;
                }
              }
            });
    ...
    const renderEmpty = () => {
      return vue.createVNode(tableTr, {
        ...
        default: () => [vue.createVNode(tableTd, {
          ...
          default: () => {
            var _a, _b;
            return [(_b = (_a = slots.empty) == null ? void 0 : _a.call(slots)) != null ? _b : vue.createVNode(index$3, null, null)];
          }
        })]
      });
    };
    ...
    const renderRecord = (record, rowIndex, {
      ...
      return vue.createVNode(vue.Fragment, null, [vue.createVNode(tableTr, vue.mergeProps({
        ...
        }, is.isFunction(props.rowClass) ? props.rowClass(record, rowIndex) : props.rowClass],
        "rowIndex": rowIndex,
        "record": record,
    ...
    const renderContent = () => {
      if (splitTable.value) {
        ...
        }), summaryData.value && summaryData.value.length && vue.createVNode("div", {
          "ref": summaryRef,
