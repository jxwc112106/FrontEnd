...
var index$L = require("./alert/index.js");
var index$10 = require("./anchor/index.js");
var index$r = require("./auto-complete/index.js");
var index$9 = require("./avatar/index.js");
var index$11 = require("./back-top/index.js");
var index$a = require("./badge/index.js");
var index$V = require("./breadcrumb/index.js");
var index$2 = require("./button/index.js");
var index = require("./calendar/index.js");
var index$b = require("./card/index.js");
var index$c = require("./carousel/index.js");
var index$s = require("./cascader/index.js");
var index$t = require("./checkbox/index.js");
var index$d = require("./collapse/index.js");
var index$e = require("./comment/index.js");
var index$12 = require("./config-provider/index.js");
var index$u = require("./date-picker/index.js");
var index$f = require("./descriptions/index.js");
var index$5 = require("./divider/index.js");
var index$M = require("./drawer/index.js");
var index$W = require("./dropdown/index.js");
var index$g = require("./empty/index.js");
var index$v = require("./form/index.js");
var index$6 = require("./grid/index.js");
var index$16 = require("./icon-component/index.js");
var index$h = require("./image/index.js");
var index$w = require("./input/index.js");
var index$x = require("./input-number/index.js");
var index$y = require("./input-tag/index.js");
var index$7 = require("./layout/index.js");
var index$3 = require("./link/index.js");
var index$j = require("./list/index.js");
var index$z = require("./mention/index.js");
var index$X = require("./menu/index.js");
var index$N = require("./message/index.js");
var index$O = require("./modal/index.js");
var index$P = require("./notification/index.js");
var index$Y = require("./page-header/index.js");
var index$Z = require("./pagination/index.js");
var index$Q = require("./popconfirm/index.js");
var index$k = require("./popover/index.js");
var index$R = require("./progress/index.js");
var index$A = require("./radio/index.js");
var index$B = require("./rate/index.js");
var index$13 = require("./resize-box/index.js");
var index$S = require("./result/index.js");
var index$i = require("./scrollbar/index.js");
var index$C = require("./select/index.js");
var index$U = require("./skeleton/index.js");
var index$D = require("./slider/index.js");
var index$8 = require("./space/index.js");
var index$T = require("./spin/index.js");
var index$15 = require("./split/index.js");
var index$l = require("./statistic/index.js");
var index$_ = require("./steps/index.js");
var index$E = require("./switch/index.js");
var index$m = require("./table/index.js");
var index$n = require("./tabs/index.js");
var index$o = require("./tag/index.js");
var index$F = require("./textarea/index.js");
var index$G = require("./time-picker/index.js");
var index$p = require("./timeline/index.js");
var index$q = require("./tooltip/index.js");
var index$H = require("./transfer/index.js");
var index$I = require("./tree/index.js");
var index$K = require("./tree-select/index.js");
var index$14 = require("./trigger/index.js");
var index$4 = require("./typography/index.js");
var index$J = require("./upload/index.js");
var index$17 = require("./overflow-list/index.js");
...
const components = {
  Button: index$2["default"],
  Link: index$3,
  Typography: index$4["default"],
  Divider: index$5,
  Grid: index$6["default"],
  Layout: index$7["default"],
  Space: index$8,
  Avatar: index$9["default"],
  Badge: index$a,
  Calendar: index,
  Card: index$b["default"],
  Carousel: index$c["default"],
  Collapse: index$d["default"],
  Comment: index$e,
  Descriptions: index$f["default"],
  Empty: index$g,
  Image: index$h["default"],
  Scrollbar: index$i,
  List: index$j["default"],
  Popover: index$k,
  Statistic: index$l["default"],
  Table: index$m["default"],
  Tabs: index$n["default"],
  Tag: index$o,
  Timeline: index$p["default"],
  Tooltip: index$q,
  AutoComplete: index$r,
  Cascader: index$s["default"],
  Checkbox: index$t["default"],
  DatePicker: index$u["default"],
  Form: index$v["default"],
  Input: index$w["default"],
  InputNumber: index$x,
  InputTag: index$y,
  Mention: index$z,
  Radio: index$A["default"],
  Rate: index$B,
  Select: index$C["default"],
  Slider: index$D,
  Switch: index$E,
  Textarea: index$F,
  TimePicker: index$G,
  ...
  Result: index$S,
  Spin: index$T,
  Skeleton: index$U["default"],
  Breadcrumb: index$V["default"],
  Dropdown: index$W["default"],
  Menu: index$X["default"],
  PageHeader: index$Y,
  Pagination: index$Z,
  Steps: index$_["default"],
  Affix: index$$,
  Anchor: index$10["default"],
  BackTop: index$11,
  ConfigProvider: index$12,
  ResizeBox: index$13,
  Trigger: index$14,
  Split: index$15,
  Icon: index$16,
  OverflowList: index$17
};
...
const ArcoVue = __spreadProps(__spreadValues({}, components), {
  ...
  TypographyText: text,
  install,
  addI18nMessages: index$1.addI18nMessages,
  useLocale: index$1.useLocale,
  getLocale: index$1.getLocale,
